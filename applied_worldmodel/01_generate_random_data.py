    ...
    for current_env_name in envs_to_generate:
        ...
        while s < total_episodes:
            ...
            for i_episode in range(batch_size):
                ...
                print("Batch {} Episode {} finished after {} timesteps".format(batch, i_episode, time + 1))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--batch_size', type = int, default = 50, help = 'how many episodes in a batch (one file)')
