...
def initialize_settings(sigma_init = 0.1, sigma_decay = 0.9999, init_opt = ''):
    ...
    population = num_worker * num_worker_trial
    filebase = './log/' + env_name + '.' + optimizer + '.' + str(num_episode) + '.' + str(population) + '.' + model.rnn.type
    controller_filebase = './controller/' + env_name + '.' + optimizer + '.' + str(num_episode) + '.' + str(population) + '.' + model.rnn.type
...
if __name__ == "__main__":
    ...
    parser.add_argument('--env_name', default = 'car_racing', type = str,
    ...
    parser.add_argument('-e', '--num_episode', type = int, default = 2, help = 'num episodes per trial (controller)')
    ...
    parser.add_argument('--max_length', type = int, help = 'maximum length of episode', default = 2000)
